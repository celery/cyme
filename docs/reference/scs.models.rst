...
.. automodule:: scs.models
    ...
    .. autoclass:: Broker
        ...
        .. attribute:: objects
            ...
            The manager for this model is :class:`~scs.managers.BrokerManager`.
    ...
    .. autoclass:: Queue
        ...
        .. attribute:: objects
            ...
            The manager for this model is :class:`~scs.managers.QueueManager`.
    ...
    .. autoclass:: Node
        ...
        .. attribute:: objects
            ...
            :class:`~scs.managers.NodeManager`.

        .. attribute:: cwd

            Working directory used by all instances.
            (Default is :file:`/var/run/scs`).
